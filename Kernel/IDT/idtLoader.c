...
void load_idt() {
  ...
  setup_IDT_entry (0x06, (uint64_t)&_exception6Handler);  // Handler para operacion invalida
 

  setup_IDT_entry (0x20, (uint64_t)&_irq00Handler);       // Handler para el timer tick
  setup_IDT_entry (0x21, (uint64_t)&_irq01Handler);       // Handler para el keyboard
