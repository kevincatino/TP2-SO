...
Sem_T *my_sem_open(uint32_t id, int initialValue)
{
...
static void removeFirstWaitingProc(Sem_T *sem)
{
...
static void deleteProcessFromSemaphore(Sem_T *sem, uint32_t pid)
{
